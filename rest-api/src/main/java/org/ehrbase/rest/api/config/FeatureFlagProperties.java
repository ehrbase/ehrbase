 ...
 * All experimental features behind {@code ehrbase.features.*} properties.
 * Disabled features result in 404 (controller bean not created via @ConditionalOnProperty).
 */
