...
public sealed interface AslProvidesJoinCondition extends AslQueryCondition permits AslFieldFieldQueryCondition {
    ...
    @Override
    default AslQueryCondition withProvider(AslQuery provider) {
