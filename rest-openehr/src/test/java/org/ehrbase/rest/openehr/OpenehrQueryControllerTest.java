...
public class OpenehrQueryControllerTest {
    ...
    //    }
    //
    //    private OpenehrQueryController controller(Supplier<QueryResultDto> resultSupplier, AqlExecutionInfo
    // executionInfo) {
    ...
    //    }
    //
    //    private OpenehrQueryController controllerStoredQuery(String storedQuery, Supplier<QueryResultDto>
    // resultSupplier) {
    ...
    //        AqlExecutionInfo executionInfo = new AqlExecutionInfo(dryRun, executedSQL, queryPlan);
    //        OpenehrQueryController controller = controllerStoredQuery(storedQuery, QueryResultDto::new,
    // executionInfo);
    //        configureExecutionOptions(controller, dryRun, executedSQL, queryPlan);
    //        return controller;
    //    }
    ...
    //        expected.setSchemaVersion("1.0.3");
    ...
    //                .executeAdHocQuery("SELECT s FROM EHR_STATUS s", null, null, null,
    ...
    //
    //        controller(QueryResultDto::new)
    //                .executeAdHocQuery("SELECT s FROM EHR_STATUS s", null, 10, null,
    // MediaType.APPLICATION_JSON_VALUE);
    //        assertAqlQueryRequest(
    ...
    //
    //        controller(QueryResultDto::new)
    //                .executeAdHocQuery("SELECT s FROM EHR_STATUS s", 25, null, null,
    // MediaType.APPLICATION_JSON_VALUE);
    //        assertAqlQueryRequest(
    ...
    //
    //        String message = assertThrowsExactly(InvalidApiParameterException.class, () ->
    // controller(QueryResultDto::new)
    //                        .executeAdHocQuery(
    ...
    //                .executeStoredQuery("my_qualified_query", "v1.0.0", null, null, null,
    // MediaType.APPLICATION_JSON_VALUE);
    //        assertAqlQueryRequest(
    //                new AqlQueryRequest("SELECT s FROM EHR_STATUS s", Map.of(), null, null, AqlExecutionOption.None));
    //    }
    ...
    //
    //        controllerStoredQuery("SELECT s FROM EHR_STATUS s", QueryResultDto::new)
    //                .executeStoredQuery("my_qualified_query", "v1.0.0", null, 15, null,
    // MediaType.APPLICATION_JSON_VALUE);
    //        assertAqlQueryRequest(
    ...
    //
    //        controllerStoredQuery("SELECT s FROM EHR_STATUS s", QueryResultDto::new)
    //                .executeStoredQuery("my_qualified_query", "v1.0.0", 25, null, null,
    // MediaType.APPLICATION_JSON_VALUE);
    //        assertAqlQueryRequest(
    //                new AqlQueryRequest("SELECT s FROM EHR_STATUS s", Map.of(), null, 25L, AqlExecutionOption.None));
    //    }
    ...
    //
    //        OpenehrQueryController controller = controllerStoredQuery("SELECT s FROM EHR_STATUS s",
    // QueryResultDto::new);
    //        controller.generatorDetailsEnabled = false;
    //
    ...
    //        assertEquals(Map.of("stored", "query"),
    // metaData.getAdditionalProperty(MetaData.AdditionalProperty.queryPlan));
    //    }
    //
    //    @Test
    ...
    //
    //        OpenehrQueryController controller = controllerStoredQuery("SELECT c FROM CONTRIBUTION c",
    // QueryResultDto::new);
    //        assertFalse(controller.executionOptionsEnabled);
    //
    //        ResponseEntity<QueryResponseData> response = controller.executeStoredQuery(
