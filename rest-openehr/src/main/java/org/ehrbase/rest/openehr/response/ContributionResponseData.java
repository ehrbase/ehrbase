...
public class ContributionResponseData {
    ...
    private List<ObjectRef<HierObjectId>> versions;

    @JsonProperty(value = "audit")
    private AuditDetails audit;

    public ContributionResponseData(HierObjectId uid, List<ObjectRef<HierObjectId>> versions, AuditDetails audit) {
        this.uid = uid;
    ...
    public List<ObjectRef<HierObjectId>> getVersions() {
        return versions;
    }

    public void setVersions(List<ObjectRef<HierObjectId>> versions) {
        this.versions = versions;
    }
