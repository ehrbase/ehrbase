...
/**
 * Admin API controller for Composition related data. Provides endpoint to remove compositions
 * physically from database.
 */
...
public class OpenehrAdminCompositionController extends BaseController {
  ...
  @Autowired
  public OpenehrAdminCompositionController(
  ...
  @ApiResponses(
      value = {
        ...
        @ApiResponse(
            code = 403,
            message =
                "Client has not permission to access this resource since admin role is missing."),
        @ApiResponse(code = 404, message = "EHR or Composition with id could not be found.")
      })
