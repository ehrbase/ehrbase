 ...
 *
 * <p>This replaces the org.ehrbase.dao.access.support.TerminologySetter class
 */
public class V3__terminology extends BaseJavaMigration {
  ...
  public void migrate(Context context) throws Exception {
    try (InputStream resourceAsStream =
        getClass().getClassLoader().getResourceAsStream("terminology.xml")) {
  ...
  private void setTerritory(final Connection connection, final Document document)
    ...
    try (final PreparedStatement statement =
      ...
      for (int idx = 0; idx < territory.getLength(); idx++) {
        ...
        final Integer code = Integer.valueOf(attributes.getNamedItem("NumericCode").getNodeValue());
  ...
  private void setConcept(final Connection connection, final Document document)
    ...
    try (final PreparedStatement statement =
      ...
      for (int idx = 0; idx < concept.getLength(); idx++) {
        ...
        final Integer code = Integer.valueOf(attributes.getNamedItem("ConceptID").getNodeValue());
