...
public final class TypeMapper {
    ...
    public static List<ColumnDescriptor> map(String rmType, String baseName) {
        return switch (rmType) {
            // === Basic types ===
            case "DV_BOOLEAN" -> List.of(
                    col(baseName, "BOOLEAN"));

            case "DV_STATE" -> List.of(
                    col(baseName, "JSONB"));

            case "DV_IDENTIFIER" -> List.of(
