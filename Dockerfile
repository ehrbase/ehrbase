...
ARG DB_URL=jdbc:postgresql://cameddb:5432/camedbase
ARG DB_USER="camedbase"
ARG DB_PASS="Colorina1"
...
ENV SECURITY_AUTHUSER="camed-user"
ENV SECURITY_AUTHPASSWORD="Colorina12"
ENV SECURITY_AUTHADMINUSER="camed-admin"
ENV SECURITY_AUTHADMINPASSWORD="Colorina123"
