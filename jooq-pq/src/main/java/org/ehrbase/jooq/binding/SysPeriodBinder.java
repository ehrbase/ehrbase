...
// meta: AbstractMap.SimpleEntry<OffsetDateTime, OffsetDateTime>is used to mimic a range as
// postgres's tstzrange is a range.
/**
 * Binding <T> = Object (unknown DB type), and <U> = {@link AbstractMap.SimpleEntry<OffsetDateTime,
 * OffsetDateTime>} (user type) for "sys_period" column (of STATUS table). See pom.xml of this
 * module for further configuration, like what columns are linked with this binding. Source:
 * https://www.jooq.org/doc/3.12/manual/code-generation/custom-data-type-bindings/
 */
public class SysPeriodBinder
    implements Binding<Object, AbstractMap.SimpleEntry<OffsetDateTime, OffsetDateTime>> {
  ...
  private static final Pattern PATTERN =
      Pattern.compile("[(\\[(]" + DATE_OR_EMPTY + "," + DATE_OR_EMPTY + "[\\])]");
    ...
    return new Converter<>() {
      ...
      public AbstractMap.SimpleEntry<OffsetDateTime, OffsetDateTime> from(Object databaseObject) {
        ...
        if (m.find()) {
          ...
          } else return new AbstractMap.SimpleEntry<>(lower, null);
        } else {
  ...
  // Methods below are mapping the converter from above to specific scenarios, i.e. calling via
  // different jooq and
   ...
   * AbstractMap.SimpleEntry<OffsetDateTime, OffsetDateTime> type
   *
  ...
  public void register(
      BindingRegisterContext<AbstractMap.SimpleEntry<OffsetDateTime, OffsetDateTime>> ctx)
      throws SQLException {
    ctx.statement().registerOutParameter(ctx.index(), Types.VARCHAR);
  }

  /**
   * Converting the AbstractMap.SimpleEntry<OffsetDateTime, OffsetDateTime> to a String value and
   * setting that on a JDBC PreparedStatement
   *
   * @param ctx internal DB context
   * @throws SQLException when SQL execution failed
   */
  @Override
  public void set(
      BindingSetStatementContext<AbstractMap.SimpleEntry<OffsetDateTime, OffsetDateTime>> ctx)
      throws SQLException {
    ctx.statement()
  ...
  @Override
  public void get(
      BindingGetResultSetContext<AbstractMap.SimpleEntry<OffsetDateTime, OffsetDateTime>> ctx)
      throws SQLException {
  ...
  @Override
  public void get(
      BindingGetStatementContext<AbstractMap.SimpleEntry<OffsetDateTime, OffsetDateTime>> ctx)
      throws SQLException {
  ...
  @Override
  public void get(
      BindingGetSQLInputContext<AbstractMap.SimpleEntry<OffsetDateTime, OffsetDateTime>> ctx)
      throws SQLException {
  ...
  @Override
  public void set(
      BindingSetSQLOutputContext<AbstractMap.SimpleEntry<OffsetDateTime, OffsetDateTime>> ctx)
      throws SQLException {
    throw new SQLFeatureNotSupportedException();
  }
}
