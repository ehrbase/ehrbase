...
/**
 * Binding <T> = Object (unknown DB type), and <U> = {@link ItemStructure} (user type) for
 * "other_details" column (of STATUS table). See pom.xml of this module for further configuration,
 * like what columns are linked with this binding. Source:
...
public class OtherDetailsJsonbBinder implements Binding<org.jooq.JSONB, ItemStructure> {
  ...
  /**
   * Rending a bind variable for the binding context's value and casting it to the ItemStructure
   * type
   *
