...
public class StoredQuery extends TableImpl<StoredQueryRecord> {
     ...
     */
    public final TableField<StoredQueryRecord, String> SEMVER = createField(DSL.name("semver"), SQLDataType.VARCHAR.nullable(false).defaultValue(DSL.field("'0.0.0'::character varying", SQLDataType.VARCHAR)), this, "");
     ...
     */
    public final TableField<StoredQueryRecord, Timestamp> CREATION_DATE = createField(DSL.name("creation_date"), SQLDataType.TIMESTAMP(6).defaultValue(DSL.field("CURRENT_TIMESTAMP", SQLDataType.TIMESTAMP)), this, "");

    /**
     * The column <code>ehr.stored_query.type</code>.
     */
    public final TableField<StoredQueryRecord, String> TYPE = createField(DSL.name("type"), SQLDataType.VARCHAR.defaultValue(DSL.field("'AQL'::character varying", SQLDataType.VARCHAR)), this, "");
    ...
    public List<Check<StoredQueryRecord>> getChecks() {
        return Arrays.asList(
            ...
            Internal.createCheck(this, DSL.name("stored_query_semver_check"), "(((semver)::text ~* '^(0|[1-9]\\d*)\\.(0|[1-9]\\d*)\\.(0|[1-9]\\d*)(?:-((?:0|[1-9]\\d*|\\d*[a-zA-Z-][0-9a-zA-Z-]*)(?:\\.(?:0|[1-9]\\d*|\\d*[a-zA-Z-][0-9a-zA-Z-]*))*))?(?:\\+([0-9a-zA-Z-]+(?:\\.[0-9a-zA-Z-]+)*))?$'::text))", true)
        );
    }
