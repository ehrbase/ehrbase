...
public class EventContext extends TableImpl<EventContextRecord> {
     ...
     */
    public final TableField<EventContextRecord, UUID> ID = createField(DSL.name("id"), SQLDataType.UUID.nullable(false).defaultValue(DSL.field("uuid_generate_v4()", SQLDataType.UUID)), this, "");
    ...
    public List<ForeignKey<EventContextRecord, ?>> getReferences() {
        return Arrays.asList(Keys.EVENT_CONTEXT__EVENT_CONTEXT_COMPOSITION_ID_FKEY, Keys.EVENT_CONTEXT__EVENT_CONTEXT_FACILITY_FKEY);
    }
