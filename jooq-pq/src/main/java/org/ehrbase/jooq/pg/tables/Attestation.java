...
public class Attestation extends TableImpl<AttestationRecord> {
     ...
     */
    public final TableField<AttestationRecord, UUID> ID = createField(DSL.name("id"), SQLDataType.UUID.nullable(false).defaultValue(DSL.field("uuid_generate_v4()", SQLDataType.UUID)), this, "");
    ...
    public List<ForeignKey<AttestationRecord, ?>> getReferences() {
        return Arrays.asList(Keys.ATTESTATION__ATTESTATION_HAS_AUDIT_FKEY, Keys.ATTESTATION__ATTESTATION_REFERENCE_FKEY);
    }
