...
public class PartyIdentified extends TableImpl<PartyIdentifiedRecord> {
     ...
     */
    public final TableField<PartyIdentifiedRecord, UUID> ID = createField(DSL.name("id"), SQLDataType.UUID.nullable(false).defaultValue(DSL.field("uuid_generate_v4()", SQLDataType.UUID)), this, "");
     ...
     */
    public final TableField<PartyIdentifiedRecord, PartyType> PARTY_TYPE = createField(DSL.name("party_type"), SQLDataType.VARCHAR.defaultValue(DSL.field("'party_identified'::ehr.party_type", SQLDataType.VARCHAR)).asEnumDataType(org.ehrbase.jooq.pg.enums.PartyType.class), this, "");
     ...
     */
    public final TableField<PartyIdentifiedRecord, PartyRefIdType> OBJECT_ID_TYPE = createField(DSL.name("object_id_type"), SQLDataType.VARCHAR.defaultValue(DSL.field("'generic_id'::ehr.party_ref_id_type", SQLDataType.VARCHAR)).asEnumDataType(org.ehrbase.jooq.pg.enums.PartyRefIdType.class), this, "");
