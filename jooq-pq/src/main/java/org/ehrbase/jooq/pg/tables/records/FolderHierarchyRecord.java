...
public class FolderHierarchyRecord extends UpdatableRecordImpl<FolderHierarchyRecord> implements Record5<UUID, UUID, UUID, Timestamp, SimpleEntry<java.time.OffsetDateTime, java.time.OffsetDateTime>> {
    ...
    @Override
    public FolderHierarchyRecord values(UUID value1, UUID value2, UUID value3, Timestamp value4, SimpleEntry<java.time.OffsetDateTime, java.time.OffsetDateTime> value5) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
     ...
     */
    public FolderHierarchyRecord(UUID parentFolder, UUID childFolder, UUID inContribution, Timestamp sysTransaction, SimpleEntry<java.time.OffsetDateTime, java.time.OffsetDateTime> sysPeriod) {
        super(FolderHierarchy.FOLDER_HIERARCHY);
