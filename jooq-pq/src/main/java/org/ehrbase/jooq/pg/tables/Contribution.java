...
public class Contribution extends TableImpl<ContributionRecord> {
     ...
     */
    public final TableField<ContributionRecord, UUID> ID = createField(DSL.name("id"), SQLDataType.UUID.nullable(false).defaultValue(DSL.field("uuid_generate_v4()", SQLDataType.UUID)), this, "");
