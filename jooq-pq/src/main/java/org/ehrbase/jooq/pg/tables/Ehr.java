...
public class Ehr extends TableImpl<EhrRecord> {
     ...
     */
    public final TableField<EhrRecord, UUID> ID = createField(DSL.name("id"), SQLDataType.UUID.nullable(false).defaultValue(DSL.field("uuid_generate_v4()", SQLDataType.UUID)), this, "");

    /**
     * The column <code>ehr.ehr.date_created</code>.
     */
    public final TableField<EhrRecord, Timestamp> DATE_CREATED = createField(DSL.name("date_created"), SQLDataType.TIMESTAMP(6).defaultValue(DSL.field("CURRENT_DATE", SQLDataType.TIMESTAMP)), this, "");
    ...
    public Folder folder() {
        if (_folder == null)
            _folder = new Folder(this, Keys.EHR__EHR_DIRECTORY_FKEY);
