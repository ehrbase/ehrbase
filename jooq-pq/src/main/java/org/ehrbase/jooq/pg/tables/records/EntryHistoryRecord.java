...
public class EntryHistoryRecord extends TableRecordImpl<EntryHistoryRecord> implements Record13<UUID, UUID, Integer, EntryType, String, UUID, String, DvCodedTextRecord, JSONB, Timestamp, SimpleEntry<java.time.OffsetDateTime, java.time.OffsetDateTime>, String, DvCodedTextRecord> {
    ...
    @Override
    public EntryHistoryRecord values(UUID value1, UUID value2, Integer value3, EntryType value4, String value5, UUID value6, String value7, DvCodedTextRecord value8, JSONB value9, Timestamp value10, SimpleEntry<java.time.OffsetDateTime, java.time.OffsetDateTime> value11, String value12, DvCodedTextRecord value13) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
