...
public class EventContextRecord extends UpdatableRecordImpl<EventContextRecord> implements Record12<UUID, UUID, Timestamp, String, Timestamp, String, UUID, String, JSONB, DvCodedTextRecord, Timestamp, SimpleEntry<java.time.OffsetDateTime, java.time.OffsetDateTime>> {
    ...
    @Override
    public EventContextRecord values(UUID value1, UUID value2, Timestamp value3, String value4, Timestamp value5, String value6, UUID value7, String value8, JSONB value9, DvCodedTextRecord value10, Timestamp value11, SimpleEntry<java.time.OffsetDateTime, java.time.OffsetDateTime> value12) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
