...
public class AttestedView extends TableImpl<AttestedViewRecord> {
     ...
     */
    public final TableField<AttestedViewRecord, UUID> ID = createField(DSL.name("id"), SQLDataType.UUID.nullable(false).defaultValue(DSL.field("uuid_generate_v4()", SQLDataType.UUID)), this, "");
