...
public class FolderHierarchyHistory extends TableImpl<FolderHierarchyHistoryRecord> {
     ...
     */
    public final TableField<FolderHierarchyHistoryRecord, UUID> PARENT_FOLDER = createField(DSL.name("parent_folder"), SQLDataType.UUID.nullable(false), this, "");

    /**
     * The column <code>ehr.folder_hierarchy_history.child_folder</code>.
     */
    public final TableField<FolderHierarchyHistoryRecord, UUID> CHILD_FOLDER = createField(DSL.name("child_folder"), SQLDataType.UUID.nullable(false), this, "");

    /**
     * The column <code>ehr.folder_hierarchy_history.in_contribution</code>.
     */
    public final TableField<FolderHierarchyHistoryRecord, UUID> IN_CONTRIBUTION = createField(DSL.name("in_contribution"), SQLDataType.UUID.nullable(false), this, "");

    /**
     * The column <code>ehr.folder_hierarchy_history.sys_transaction</code>.
     */
    public final TableField<FolderHierarchyHistoryRecord, Timestamp> SYS_TRANSACTION = createField(DSL.name("sys_transaction"), SQLDataType.TIMESTAMP(6).nullable(false), this, "");

    /**
     * The column <code>ehr.folder_hierarchy_history.sys_period</code>.
     */
    public final TableField<FolderHierarchyHistoryRecord, SimpleEntry<java.time.OffsetDateTime, java.time.OffsetDateTime>> SYS_PERIOD = createField(DSL.name("sys_period"), org.jooq.impl.DefaultDataType.getDefaultDataType("\"pg_catalog\".\"tstzrange\"").nullable(false), this, "", new SysPeriodBinder());
