...
public class AdminDeleteFolder extends TableImpl<AdminDeleteFolderRecord> {
     ...
     */
    public final TableField<AdminDeleteFolderRecord, UUID> CONTRIBUTION = createField(DSL.name("contribution"), SQLDataType.UUID, this, "");

    /**
     * The column <code>ehr.admin_delete_folder.child</code>.
     */
    public final TableField<AdminDeleteFolderRecord, UUID> CHILD = createField(DSL.name("child"), SQLDataType.UUID, this, "");

    /**
     * The column <code>ehr.admin_delete_folder.audit</code>.
     */
    public final TableField<AdminDeleteFolderRecord, UUID> AUDIT = createField(DSL.name("audit"), SQLDataType.UUID, this, "");
     ...
     */
    public AdminDeleteFolder call(
          UUID folderIdInput
    ) {
        AdminDeleteFolder result = new AdminDeleteFolder(DSL.name("admin_delete_folder"), null, new Field[] {
