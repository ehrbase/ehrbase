...
public class SessionLog extends TableImpl<SessionLogRecord> {
     ...
     */
    public final TableField<SessionLogRecord, UUID> ID = createField(DSL.name("id"), SQLDataType.UUID.nullable(false).defaultValue(DSL.field("uuid_generate_v4()", SQLDataType.UUID)), this, "");
