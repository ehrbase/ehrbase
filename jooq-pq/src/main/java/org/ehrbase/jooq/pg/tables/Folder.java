...
public class Folder extends TableImpl<FolderRecord> {
     ...
     */
    public final TableField<FolderRecord, UUID> ID = createField(DSL.name("id"), SQLDataType.UUID.nullable(false).defaultValue(DSL.field("uuid_generate_v4()", SQLDataType.UUID)), this, "");

    /**
     * The column <code>ehr.folder.in_contribution</code>.
     */
    public final TableField<FolderRecord, UUID> IN_CONTRIBUTION = createField(DSL.name("in_contribution"), SQLDataType.UUID.nullable(false), this, "");

    /**
     * The column <code>ehr.folder.name</code>.
     */
    public final TableField<FolderRecord, String> NAME = createField(DSL.name("name"), SQLDataType.CLOB.nullable(false), this, "");

    /**
     * The column <code>ehr.folder.archetype_node_id</code>.
     */
    public final TableField<FolderRecord, String> ARCHETYPE_NODE_ID = createField(DSL.name("archetype_node_id"), SQLDataType.CLOB.nullable(false), this, "");

    /**
     * The column <code>ehr.folder.active</code>.
     */
    public final TableField<FolderRecord, Boolean> ACTIVE = createField(DSL.name("active"), SQLDataType.BOOLEAN.defaultValue(DSL.field("true", SQLDataType.BOOLEAN)), this, "");

    /**
     * The column <code>ehr.folder.details</code>.
     */
    public final TableField<FolderRecord, ItemStructure> DETAILS = createField(DSL.name("details"), SQLDataType.JSONB, this, "", new OtherDetailsJsonbBinder());

    /**
     * The column <code>ehr.folder.sys_transaction</code>.
     */
    public final TableField<FolderRecord, Timestamp> SYS_TRANSACTION = createField(DSL.name("sys_transaction"), SQLDataType.TIMESTAMP(6).nullable(false), this, "");

    /**
     * The column <code>ehr.folder.sys_period</code>.
     */
    public final TableField<FolderRecord, SimpleEntry<java.time.OffsetDateTime, java.time.OffsetDateTime>> SYS_PERIOD = createField(DSL.name("sys_period"), org.jooq.impl.DefaultDataType.getDefaultDataType("\"pg_catalog\".\"tstzrange\"").nullable(false), this, "", new SysPeriodBinder());

    /**
     * The column <code>ehr.folder.has_audit</code>.
     */
    public final TableField<FolderRecord, UUID> HAS_AUDIT = createField(DSL.name("has_audit"), SQLDataType.UUID.nullable(false), this, "");
    ...
    public Contribution contribution() {
        if (_contribution == null)
            _contribution = new Contribution(this, Keys.FOLDER__FOLDER_IN_CONTRIBUTION_FKEY);
    ...
    public AuditDetails auditDetails() {
        if (_auditDetails == null)
            _auditDetails = new AuditDetails(this, Keys.FOLDER__FOLDER_HAS_AUDIT_FKEY);
