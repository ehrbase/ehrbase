...
public class ObjectRefRecord extends UpdatableRecordImpl<ObjectRefRecord>
        implements Record6<
                String,
                String,
                UUID,
    ...
    @Override
    public ObjectRefRecord value6(SimpleEntry<java.time.OffsetDateTime, java.time.OffsetDateTime> value) {
        setSysPeriod(value);
        return this;
    }

    @Override
    public ObjectRefRecord values(
            String value1,
            String value2,
            UUID value3,
            UUID value4,
