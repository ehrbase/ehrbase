...
public class AuditDetails extends TableImpl<AuditDetailsRecord> {
     ...
     */
    public final TableField<AuditDetailsRecord, UUID> ID = createField(DSL.name("id"), SQLDataType.UUID.nullable(false).defaultValue(DSL.field("uuid_generate_v4()", SQLDataType.UUID)), this, "");
     ...
     */
    public final TableField<AuditDetailsRecord, Timestamp> TIME_COMMITTED = createField(DSL.name("time_committed"), SQLDataType.TIMESTAMP(6).defaultValue(DSL.field("now()", SQLDataType.TIMESTAMP)), this, "");
    ...
    public List<ForeignKey<AuditDetailsRecord, ?>> getReferences() {
        return Arrays.asList(Keys.AUDIT_DETAILS__AUDIT_DETAILS_SYSTEM_ID_FKEY, Keys.AUDIT_DETAILS__AUDIT_DETAILS_COMMITTER_FKEY);
    }
