...
public class ObjectRefHistoryRecord extends UpdatableRecordImpl<ObjectRefHistoryRecord> implements Record6<String, String, UUID, UUID, Timestamp, SimpleEntry<java.time.OffsetDateTime, java.time.OffsetDateTime>> {
    ...
    @Override
    public ObjectRefHistoryRecord values(String value1, String value2, UUID value3, UUID value4, Timestamp value5, SimpleEntry<java.time.OffsetDateTime, java.time.OffsetDateTime> value6) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
     ...
     */
    public ObjectRefHistoryRecord(String idNamespace, String type, UUID id, UUID inContribution, Timestamp sysTransaction, SimpleEntry<java.time.OffsetDateTime, java.time.OffsetDateTime> sysPeriod) {
        super(ObjectRefHistory.OBJECT_REF_HISTORY);
