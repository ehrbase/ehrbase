...
public class Status extends TableImpl<StatusRecord> {
     ...
     */
    public final TableField<StatusRecord, UUID> ID = createField(DSL.name("id"), SQLDataType.UUID.nullable(false).defaultValue(DSL.field("uuid_generate_v4()", SQLDataType.UUID)), this, "");
     ...
     */
    public final TableField<StatusRecord, Boolean> IS_QUERYABLE = createField(DSL.name("is_queryable"), SQLDataType.BOOLEAN.defaultValue(DSL.field("true", SQLDataType.BOOLEAN)), this, "");

    /**
     * The column <code>ehr.status.is_modifiable</code>.
     */
    public final TableField<StatusRecord, Boolean> IS_MODIFIABLE = createField(DSL.name("is_modifiable"), SQLDataType.BOOLEAN.defaultValue(DSL.field("true", SQLDataType.BOOLEAN)), this, "");
     ...
     */
    public final TableField<StatusRecord, String> ARCHETYPE_NODE_ID = createField(DSL.name("archetype_node_id"), SQLDataType.CLOB.nullable(false).defaultValue(DSL.field("'openEHR-EHR-EHR_STATUS.generic.v1'::text", SQLDataType.CLOB)), this, "");
    ...
    public List<ForeignKey<StatusRecord, ?>> getReferences() {
        return Arrays.asList(Keys.STATUS__STATUS_EHR_ID_FKEY, Keys.STATUS__STATUS_PARTY_FKEY, Keys.STATUS__STATUS_HAS_AUDIT_FKEY, Keys.STATUS__STATUS_ATTESTATION_REF_FKEY, Keys.STATUS__STATUS_IN_CONTRIBUTION_FKEY);
    }
