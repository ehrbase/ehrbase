...
public class Composition extends TableImpl<CompositionRecord> {
     ...
     */
    public final TableField<CompositionRecord, UUID> ID = createField(DSL.name("id"), SQLDataType.UUID.nullable(false).defaultValue(DSL.field("uuid_generate_v4()", SQLDataType.UUID)), this, "");
     ...
     */
    public final TableField<CompositionRecord, Boolean> ACTIVE = createField(DSL.name("active"), SQLDataType.BOOLEAN.defaultValue(DSL.field("true", SQLDataType.BOOLEAN)), this, "");

    /**
     * The column <code>ehr.composition.is_persistent</code>.
     */
    public final TableField<CompositionRecord, Boolean> IS_PERSISTENT = createField(DSL.name("is_persistent"), SQLDataType.BOOLEAN.defaultValue(DSL.field("true", SQLDataType.BOOLEAN)), this, "");
