...
public class ParticipationHistoryRecord extends TableRecordImpl<ParticipationHistoryRecord> implements Record11<UUID, UUID, UUID, DvCodedTextRecord, DvCodedTextRecord, Timestamp, String, Timestamp, SimpleEntry<java.time.OffsetDateTime, java.time.OffsetDateTime>, Timestamp, String> {
    ...
    @Override
    public Row11<UUID, UUID, UUID, DvCodedTextRecord, DvCodedTextRecord, Timestamp, String, Timestamp, SimpleEntry<java.time.OffsetDateTime, java.time.OffsetDateTime>, Timestamp, String> valuesRow() {
    ...
    @Override
    public ParticipationHistoryRecord values(UUID value1, UUID value2, UUID value3, DvCodedTextRecord value4, DvCodedTextRecord value5, Timestamp value6, String value7, Timestamp value8, SimpleEntry<java.time.OffsetDateTime, java.time.OffsetDateTime> value9, Timestamp value10, String value11) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
     ...
     */
    public ParticipationHistoryRecord(UUID id, UUID eventContext, UUID performer, DvCodedTextRecord function, DvCodedTextRecord mode, Timestamp timeLower, String timeLowerTz, Timestamp sysTransaction, SimpleEntry<java.time.OffsetDateTime, java.time.OffsetDateTime> sysPeriod, Timestamp timeUpper, String timeUpperTz) {
        super(ParticipationHistory.PARTICIPATION_HISTORY);
