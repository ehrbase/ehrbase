...
AQL SMOKE TEST
    ...
    # PRECONDITIONS
        ...
        # comment: Generate Test-Data and Expected-Results
        ...
        # Commit Compo    2    1    ${compo data sets}/minimal_admin_2.composition.json
        # Commit Compo    3    1    ${compo data sets}/minimal_admin_3.composition.json
        # Commit Compo    4    1    ${compo data sets}/minimal_evaluation_1.composition.json
        ...
        # Commit Compo    17    1    ${compo data sets}/minimal_action2_1.composition.json
    ...
    # QUERY EXECUTION
        ...
        #////////////////////////////////////////////////////
        #//                                               ///
        #//  UNCOMMENT MORE QUERIES TO EXTEND SMOKE TEST  ///
        #//                                               ///
        #////////////////////////////////////////////////////
        ...
        # execute ad-hoc query and check result (loaded DB)  B/800_query.tmp.json    B/800.tmp.json
        # execute ad-hoc query and check result (loaded DB)  B/801_query.tmp.json    B/801.tmp.json
