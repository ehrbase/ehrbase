...
public record RmAttribute(String attribute, String alias) {
    ...
    static {
        attribute2alias =
                VALUES.stream().collect(Collectors.toMap(RmAttribute::attribute, RmAttribute::alias));
        alias2attribute =
                VALUES.stream().collect(Collectors.toMap(RmAttribute::alias, RmAttribute::attribute));
    }
