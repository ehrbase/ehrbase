...
public class ObjectDataHistoryRecordPrototype extends AbstractRecordPrototype<ObjectDataHistoryRecordPrototype> {

    private static final long serialVersionUID = 1L;
    static final EnumMap<FieldPrototype, Integer> COLUMNS = determineColumns(false, false);
    ...
    @Override
    public Record4<UUID, Short, Integer, Integer> key() {
    ...
    public ObjectDataHistoryRecordPrototype() {
        super(ObjectDataHistoryTablePrototype.INSTANCE);
    }
