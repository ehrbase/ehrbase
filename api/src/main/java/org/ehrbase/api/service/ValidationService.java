 ...
 * ValidationService
 *
 * <p>performs a composition validation based on the constraints defined in a 1.4 operational
 * template The service is a wrapper of Validator and use a cache to optimize validation since the
