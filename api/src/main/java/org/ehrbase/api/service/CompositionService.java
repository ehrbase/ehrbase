...
public interface CompositionService extends BaseService {
  ...
  /**
   * Overloaded wrapper function to create composition with minimal set of input. TemplateID is read
   * from composition content.
   *
  ...
  /**
   * Creates a deserialized representation of the composition data from source format and stores
   * these data into the corresponding tables.
   *
   * @param ehrId - Target EHR
   * @param content - String representation of content
   * @param format - Format of data within the string representation
   ...
   */
  UUID create(
      UUID ehrId, String content, CompositionFormat format, String templateId, UUID linkUid);

  /**
   * Creates a composition which will be connected to the given existing contribution. Unlike with
   * the general create() methods, where the contribution will be created ad hoc.
   *
   * @param ehrId Target EHR
  ...
  /**
   * Overloaded wrapper function to update composition with minimal set of input. TemplateID is read
   * from composition content.
   *
   * @param compositionId
   * @param format
  ...
  /**
   * Updates an existing composition entry with new data. Implicitly created new contribution
   * ad-hoc.
   *
  ...
  /**
   * Updates a composition which will be connected to the given existing contribution. Unlike with
   * the general update() methods, where the contribution will be created ad hoc.
   *
   * @param compositionId Target composition UUID to update
   * @param composition Composition as RM object
   * @param contributionId ID of the contribution this composition is part of
  ...
  /**
   * Deletes a composition which will be connected to the given existing contribution. Unlike with
   * the general delete() methods, where the contribution will be created ad hoc.
   *
   * @param compositionId Target composition UUID
  ...
  /**
   * Admin method to delete a Composition from the DB. See EHRbase Admin API specification for
   * details.
   *
