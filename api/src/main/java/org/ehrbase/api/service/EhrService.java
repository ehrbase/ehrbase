...
public interface EhrService extends BaseService {
   ...
   */
  Optional<OriginalVersion<EhrStatus>> getEhrStatusAtVersion(
  ...
  /**
   * Return True if a EHR with identifier ehrId exists. Implements has_ehr from the openEHR Platform
  ...
  /**
   * Removes the directory information from EHR table entry after deletion of the corresponding
   * folder from folders table. If there were no such folder it will return a successful deletion.
   *
