...
public class KnowledgeCacheServiceTest {
  ...
  public void testNonUniqueAqlPathsTemplateId() throws Exception {
    ...
    //resolve
    JsonPathQueryResult jsonPathQueryResult = knowledge.resolveForTemplate("non_unique_aql_paths",
        nodeIds);
  ...
  public static KnowledgeCacheService buildKnowledgeCache(TemporaryFolder folder,
    ...
    return new KnowledgeCacheService(templateFileStorageService, new ConcurrentMapCacheManager(),
        new CacheOptions());
  }
