...
/**
 * This mock data provider coresponds to the versioning of folders with the status in the file
 * testFolderVersionsDB.sql
 */
  ...
  public MockResult[] execute(MockExecuteContext ctx) throws SQLException {
    ...
    if (sql2.toUpperCase().startsWith("DROP")) {
      ...
      throw new SQLException("Statement not supported: " + sql2);
        ...
        .contains(
            "select \"alias_90044192\".\"folder_id\", \"alias_90044192\".\"item_object_ref_id\", \"alias_90044192\".\"item_in_contribution\"")) {

      if (((UUID) ctx.bindings()[1])
          .equals(UUID.fromString("00550555-ec91-4025-838d-09ddb4e473cb"))) {

        if (((UUID) ctx.bindings()[0])
            .equals(UUID.fromString("129dc79c-e0bc-4946-bfa6-28ce609bbd2c"))) {
          ...
          return mock2;
            ...
            .equals(UUID.fromString("eda6951b-5506-4726-89dc-7032872997ce"))) {
          MockResult[] mock2 = new MockResult[1];
          Result<
                  Record11<
                      UUID,
      ...
      if (((Timestamp) ctx.bindings()[0]).before(Timestamp.valueOf("2020-01-15 22:22:22.688"))) {
        ...
        if (sql2.toLowerCase()
            .contains(
                "with recursive \"subfolders\" as ((select \"alias_12246427\".\"parent_folder\", \"alias_12246427\".\"child_folder\"")) {
          //
