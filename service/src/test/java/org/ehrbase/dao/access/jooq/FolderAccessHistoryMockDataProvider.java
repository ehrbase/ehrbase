        ...
        public class FolderAccessHistoryMockDataProvider implements MockDataProvider{
            ...
            public MockResult[] execute(MockExecuteContext ctx) throws SQLException {
                ...
                if (sql2.toUpperCase().startsWith("DROP")) {
                    ...
                    throw new SQLException("Statement not supported: " + sql2);
                }else if(sql2.toLowerCase().contains("select \"alias_82887042\".\"folder_id\", \"alias_82887042\".\"item_object_ref_id\", \"alias_82887042\".\"item_in_contribution\"")) {
                    ...
                    if (((Timestamp) ctx.bindings()[0]).before(Timestamp.valueOf("2020-01-15 22:22:22.688"))) {
                        ...
                        if (sql2.toLowerCase().contains("with recursive \"subfolders\" as (select \"alias_50362573\".\"parent_folder\", \"alias_50362573\".\"child_folder\"")) {
