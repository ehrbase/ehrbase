...
public class CompAccessTestMockDataProvider implements MockDataProvider {
  ...
  public MockResult[] execute(MockExecuteContext ctx) throws SQLException {
    ...
    if (sql2.toUpperCase().startsWith("DROP")) {
      ...
      result2.add(
          create
              ...
              .values(
                  new Timestamp(
                      Long.parseLong(
                          "1557225716546")))); // 1557225716546, that is  2019-05-07 12:41:56.546
      mock[0] = new MockResult(1, result2);
      return mock;
      ...
      Result<Record1<Integer>> result2 = create.newResult(c);
      result2.add(
          create.newRecord(c).values(13)); // composition history contains 13 rows for the id
      ...
      if (((Timestamp) ctx.bindings()[0]).compareTo(new Timestamp(Long.parseLong("1557222155000")))
          == 0) {
        ...
        mock[0] = new MockResult(1, result2);
      } else if (((Timestamp) ctx.bindings()[0])
              .compareTo(new Timestamp(Long.parseLong("1557157680000")))
          == 0) { // 6-may-2019 17:48
        ...
        mock[0] = new MockResult(1, result2);
              ...
              .compareTo(new Timestamp(Long.parseLong("1546344000000")))
          == 0) { // 1-jan-2019 13:00
        ...
        mock[0] = new MockResult(1, result2);
              ...
              .compareTo(new Timestamp(Long.parseLong("1562673600000")))
        ...
        result2.add(
            create
                .newRecord(c)
                .values(13)); // if a timestamp bigger than any in the composition_history table is
        // received return the max num of rows, 13
        mock[0] = new MockResult(1, result2);
      } else if (sql2.toUpperCase()
          .startsWith(
