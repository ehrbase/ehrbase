...
public class FolderMockDataProvider implements MockDataProvider {
  ...
  public MockResult[] execute(MockExecuteContext ctx) throws SQLException {
    ...
    if (sql2.toUpperCase().startsWith("DROP")) {
      ...
      if (((UUID) ctx.bindings()[0])
              .compareTo(UUID.fromString("77750555-ec91-4025-838d-09ddb4e999cb"))
          == 0) {
        ...
        return mock2;
      } else if (((UUID) ctx.bindings()[0])
              .compareTo(UUID.fromString("8701233c-c8fd-47ba-91b5-ef9ff23c259b"))
          == 0) {
      ...
      if (sql2.toUpperCase()
        ...
        if (((UUID) ctx.bindings()[0])
                .compareTo(UUID.fromString("00550555-ec91-4025-838d-09ddb4e999cb"))
            == 0) {
          ...
          MockResult[] mock2 = new MockResult[1];
          Result<Record4<UUID, UUID, UUID, Timestamp>> result2 =
              create.newResult(
        ...
        if (((UUID) ctx.bindings()[0])
          ...
          return mock2;
                ...
                .compareTo(UUID.fromString("33550555-ec91-4025-838d-09ddb4e999cb"))
            == 0) {
      ...
      return mock;
        ...
        .contains(
            "SELECT \"EHR\".\"PARTY_IDENTIFIED\"")) { // query needed for mocking initialization of
      // the system
      System.out.println("SQL2 is: " + sql2.toUpperCase());
      System.out.println("PARTY_IDENTIFIED hist selected");
      Result<Record6<UUID, String, String, String, String, String>> result2 =
          create.newResult(
              PARTY_IDENTIFIED.ID,
      ...
      result2.add(
          create
              .newRecord(
                  ...
                  PARTY_IDENTIFIED.PARTY_REF_TYPE)
              .values(
                  UUID.fromString(TEST_PARTY_IDENTIFIED_ID),
                  "Dr Tony Blegon",
                  null,
                  null,
                  null,
      ...
      if (((UUID) ctx.bindings()[0])
              .compareTo(UUID.fromString("f6a2af65-fe89-45a4-9456-07c5e17b1634"))
          == 0) {
      ...
      throw new SQLException(
        ...
        .startsWith("INSERT INTO \"EHR\".\"FOLDER\" (\"ID\", \"IN_CONTRIBUTION\",")) {
      ...
      if (sql2.toUpperCase()
        ...
        if (((UUID) ctx.bindings()[0])
                .compareTo(UUID.fromString("f0a2af65-fe89-45a4-9456-07c5e17b1634"))
            == 0) {
        ...
        if (((UUID) ctx.bindings()[0])
                .compareTo(UUID.fromString("f8a2af65-fe89-45a4-9456-07c5e17b1634"))
            == 0) {
          Result<Record1<UUID>> result2 = create.newResult(FOLDER.ID);
          result2.add(
              create
        ...
        if (((UUID) ctx.bindings()[0])
                .compareTo(UUID.fromString("f4a2af65-fe89-45a4-9456-07c5e17b1634"))
            == 0) {
          Result<Record1<UUID>> result2 = create.newResult(FOLDER.ID);
          result2.add(
              create
      ...
      if ((uidParentFolder.equals("f0a2af65-fe89-45a4-9456-07c5e17b1634"))
        ...
        .startsWith("UPDATE \"EHR\".\"CONTRIBUTION\" SET \"CONTRIBUTION_TYPE\"")) {
      Field<Integer> c = DSL.count();
      Result<Record1<Integer>> result2 = create.newResult(c);
      result2.add(create.newRecord(c).values(1));
      mock[0] = new MockResult(1, result2);
      ...
      if ((((UUID) ctx.bindings()[0])
        ...
        return mock;
                  ...
                  .compareTo(UUID.fromString("99550555-ec91-4025-838d-09ddb4e999cb"))
              == 0)
          && (((UUID) ctx.bindings()[1])
                  .compareTo(UUID.fromString("00550555-ec91-4025-838d-09ddb4e999cb"))
              == 0)
        ...
        return mock;
              ...
              == 0)
          && (((UUID) ctx.bindings()[1])
                  .compareTo(UUID.fromString("3e2fcd27-d846-4a0d-888a-47b2da9e5cbb"))
              == 0)) {
      ...
      if ((((UUID) ctx.bindings()[0]).compareTo(UUID.fromString(TEST_SYSTEM_ID)) == 0)
          && (((UUID) ctx.bindings()[1]).compareTo(UUID.fromString(TEST_PARTY_IDENTIFIED_ID))
              == 0)) {
