...
public class QueryCompilerPass1Test {
    ...
    public void testGetIdentifierMapper() {
        ...
        // variable for ehr with predicate
        {
            QueryCompilerPass1 cut = new QueryCompilerPass1();
            String aql = "select e/ehr_id/value " +
                    "from EHR e [ehr_id/value = '26332710-16f3-4b54-aae9-4d11c141388c']";
            ParseTree tree = QueryHelper.setupParseTree(aql);
            walker.walk(cut, tree);
            ...
            assertThat(identifierMapper.getEhrContainer().getValue()).isEqualTo("'26332710-16f3-4b54-aae9-4d11c141388c'");
        }
    ...
    public void testGetClosedSetList() {
        ...
        // single containment
        {
            ...
            Containment expected = ContainmentTest.buildContainment(null, "a", "openEHR-EHR-COMPOSITION.health_summary.v1", "COMPOSITION", null);
        ...
        // nested containment
        {
            ...
            Containment expected2 = ContainmentTest.buildContainment(containment1, "d", "openEHR-EHR-ACTION.immunisation_procedure.v1", "ACTION", null);
        ...
        // triple nested containment
        {
            QueryCompilerPass1 cut = new QueryCompilerPass1();
            String aql = "select e/ehr_id/value " +
                    "from EHR e  contains COMPOSITION a[openEHR-EHR-COMPOSITION.health_summary.v1] contains ACTION d[openEHR-EHR-ACTION.immunisation_procedure.v1] contains CLUSTER a_a[openEHR-EHR-CLUSTER.device.v1]";
            ParseTree tree = QueryHelper.setupParseTree(aql);
            walker.walk(cut, tree);
            List<ContainmentSet> actual = cut.getClosedSetList();
            assertThat(actual).size().isEqualTo(1);
            ...
            Containment expected3 = ContainmentTest.buildContainment(containment1, "a_a", "openEHR-EHR-CLUSTER.device.v1", "CLUSTER", null);
            ContainmentTest.checkEqual(containment2, expected2);
        }
        ...
        // boolean operators
        {
            QueryCompilerPass1 cut = new QueryCompilerPass1();
            String aql = "select e/ehr_id/value" +
                    " from EHR e CONTAINS COMPOSITION a [openEHR-EHR-COMPOSITION.health_summary.v1] AND COMPOSITION d [openEHR-EHR-COMPOSITION.referral.v1]";
            ParseTree tree = QueryHelper.setupParseTree(aql);
            walker.walk(cut, tree);
            List<ContainmentSet> actual = cut.getClosedSetList();
            assertThat(actual).size().isEqualTo(1);
        ...
        // multiple of the same  boolean operators
        {
            QueryCompilerPass1 cut = new QueryCompilerPass1();
            String aql = "select e/ehr_id/value" +
                    " from EHR e CONTAINS COMPOSITION a [openEHR-EHR-COMPOSITION.health_summary.v1] XOR COMPOSITION d [openEHR-EHR-COMPOSITION.administrative_encounter.v1] XOR  COMPOSITION c [openEHR-EHR-COMPOSITION.referral.v1] ";
            ParseTree tree = QueryHelper.setupParseTree(aql);
            walker.walk(cut, tree);
            List<ContainmentSet> actual = cut.getClosedSetList();
            assertThat(actual).size().isEqualTo(1);
        ...
        // multiple of different  boolean operators
        {
            QueryCompilerPass1 cut = new QueryCompilerPass1();
            String aql = "select e/ehr_id/value" +
                    " from EHR e CONTAINS COMPOSITION a [openEHR-EHR-COMPOSITION.health_summary.v1] XOR ACTION d [openEHR-EHR-ACTION.immunisation_procedure.v1] AND COMPOSITION c [openEHR-EHR-COMPOSITION.referral.v1] ";
            ParseTree tree = QueryHelper.setupParseTree(aql);
            walker.walk(cut, tree);
            List<ContainmentSet> actual = cut.getClosedSetList();
            assertThat(actual).size().isEqualTo(1);
        ...
        // boolean operators in nested containment
        {
            ...
            Containment expected1 = ContainmentTest.buildContainment(null, "c", "openEHR-EHR-COMPOSITION.referral.v1", "COMPOSITION", null);
            ContainmentTest.checkEqual(containment1, expected1);
        ...
        // boolean operators over nested containment
        {
            ...
            String aql = "select e/ehr_id/value" +
                    " from EHR e CONTAINS (COMPOSITION c [openEHR-EHR-COMPOSITION.referral.v1]\n" +
                    "        CONTAINS OBSERVATION o [openEHR-EHR-OBSERVATION.laboratory-hba1c.v1]) OR COMPOSITION c2 [openEHR-EHR-COMPOSITION.health_summary.v1]";
            ParseTree tree = QueryHelper.setupParseTree(aql);
            walker.walk(cut, tree);
            List<ContainmentSet> actual = cut.getClosedSetList();
            assertThat(actual).size().isEqualTo(2);
            ...
            ContainmentSet containmentSet1 = actual.get(0);
            assertThat(containmentSet1.getEnclosing()).isEqualTo(ContainmentTest.buildContainment(null, null, null, null, null));
            ...
            Containment expected2 = ContainmentTest.buildContainment(containment1, "o", "openEHR-EHR-OBSERVATION.laboratory-hba1c.v1", "OBSERVATION", null);
            ContainmentTest.checkEqual(containment2, expected2);
        }
