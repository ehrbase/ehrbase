...
public class QueryCompilerPass1Test extends TestAqlBase {
  ...
  public void testGetIdentifierMapper() {
    ...
    // variable for ehr and compose
    {
      ...
      assertThat(identifierMapper.getArchetypeId("a"))
          .isEqualTo("openEHR-EHR-COMPOSITION.health_summary.v1");
    }
  ...
  // a[openEHR-EHR-COMPOSITION.health_summary.v1]";
  //            ParseTree tree = QueryHelper.setupParseTree(aql);
  //            walker.walk(cut, tree);
  //            List<ContainmentSet> actual = cut.getClosedSetList();
  //            assertThat(actual).size().isEqualTo(1);
  ...
  //            String aql = "select e/ehr_id/value " +
  //                    "from EHR e  contains COMPOSITION
  // a[openEHR-EHR-COMPOSITION.health_summary.v1] contains ACTION
  ...
  //                    "from EHR e  contains COMPOSITION
  // a[openEHR-EHR-COMPOSITION.health_summary.v1] contains ACTION
  // d[openEHR-EHR-ACTION.immunisation_procedure.v1] contains CLUSTER
  // a_a[openEHR-EHR-CLUSTER.device.v1]";
  //            ParseTree tree = QueryHelper.setupParseTree(aql);
  //            walker.walk(cut, tree);
  //            List<ContainmentSet> actual = cut.getClosedSetList();
  //            assertThat(actual).size().isEqualTo(1);
  ...
  // [openEHR-EHR-COMPOSITION.health_summary.v1] AND COMPOSITION d
  ...
  //            String aql = "select e/ehr_id/value" +
  //                    " from EHR e CONTAINS COMPOSITION a
  // [openEHR-EHR-COMPOSITION.health_summary.v1] XOR COMPOSITION d
  // [openEHR-EHR-COMPOSITION.administrative_encounter.v1] XOR  COMPOSITION c
  // [openEHR-EHR-COMPOSITION.referral.v1] ";
  //            ParseTree tree = QueryHelper.setupParseTree(aql);
  //            walker.walk(cut, tree);
  //            List<ContainmentSet> actual = cut.getClosedSetList();
  ...
  //            String aql = "select e/ehr_id/value" +
  //                    " from EHR e CONTAINS COMPOSITION a
  // [openEHR-EHR-COMPOSITION.health_summary.v1] XOR ACTION d
  // [openEHR-EHR-ACTION.immunisation_procedure.v1] AND COMPOSITION c
  // [openEHR-EHR-COMPOSITION.referral.v1] ";
  //            ParseTree tree = QueryHelper.setupParseTree(aql);
  //            walker.walk(cut, tree);
  //            List<ContainmentSet> actual = cut.getClosedSetList();
  ...
  // [openEHR-EHR-OBSERVATION.laboratory-hba1c.v1] AND OBSERVATION o1
  ...
  //
  //
  //            Containment containment1 = (Containment)
  // containmentSet2.getContainmentList().get(0);
  ...
  // containmentSet1.getContainmentList().get(0);
  ...
  //
  //            Containment containment3 = (Containment)
  // containmentSet1.getContainmentList().get(2);
  ...
  // [openEHR-EHR-COMPOSITION.referral.v1]\n" +
  //                    "        CONTAINS OBSERVATION o
  // [openEHR-EHR-OBSERVATION.laboratory-hba1c.v1]) OR COMPOSITION c2
  ...
  //
  //            Containment containment3 = (Containment)
  // containmentSet2.getContainmentList().get(1);
  ...
  //            ContainmentSet containmentSet1 = actual.get(0);
  //
  // assertThat(containmentSet1.getEnclosing()).isEqualTo(ContainmentTest.buildContainment(null,
  // null, null, null, null));
  ...
  //
  //            Containment containment2 = (Containment)
  // containmentSet1.getContainmentList().get(1);
