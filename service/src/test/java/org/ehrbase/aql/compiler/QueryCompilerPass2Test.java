...
public class QueryCompilerPass2Test {
  ...
  public void getVariables() {
    ...
    // multiple variables
    {
      ...
      I_VariableDefinition expected2 =
      ...
      I_VariableDefinition expected3 =
          I_VariableDefinitionHelper.build(
  ...
  public void getOrderAttributes() {
...

    {
      QueryCompilerPass2 cut = new QueryCompilerPass2();
      String aql =
          "select a/uid/value as uid, a/composer/name as author, a/context/start_time/value  "
      ...
      I_VariableDefinition expected =
          I_VariableDefinitionHelper.build(
              "context/start_time/value", null, "a", false, false, false);
  ...
  public void getOffsetAttribute() {
    ...
    {
      QueryCompilerPass2 cut = new QueryCompilerPass2();
      String aql = "select e/ehr_id/value " + "from EHR e OFFSET 6 ";
      ParseTree tree = QueryHelper.setupParseTree(aql);
      walker.walk(cut, tree);
      Integer actual = cut.getOffsetAttribute();
      assertThat(actual).isEqualTo(6);
  ...
  public void testFunction1() {
...

    {
      QueryCompilerPass2 cut = new QueryCompilerPass2();
      String aql =
          "select count(a/context/start_time/value)  "
              + "from EHR e  contains COMPOSITION a[openEHR-EHR-COMPOSITION.health_summary.v1] ";
      ParseTree tree = QueryHelper.setupParseTree(aql);
      walker.walk(cut, tree);
