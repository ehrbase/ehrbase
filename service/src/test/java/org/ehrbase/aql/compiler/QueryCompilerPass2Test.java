...
public class QueryCompilerPass2Test {
    ...
    public void getVariables() {
...

        {
            ...
            I_VariableDefinition expected = I_VariableDefinitionHelper.build("ehr_id/value", null, "e", false, false, false);
        ...
        //DISTINCT
        {
            ...
            assertThat(variables).size().isEqualTo(1);
            I_VariableDefinition variableDefinition = variables.get(0);
            I_VariableDefinition expected = I_VariableDefinitionHelper.build("ehr_id/value", null, "e", true, false, false);
            I_VariableDefinitionHelper.checkEqualWithoutFuncParameters(variableDefinition, expected);
        }
        ...
        {
            QueryCompilerPass2 cut = new QueryCompilerPass2();
            String aql = "select e/ehr_id/value as id " +
                    "from EHR e ";
            ParseTree tree = QueryHelper.setupParseTree(aql);
            walker.walk(cut, tree);
            List<I_VariableDefinition> variables = cut.getVariables();
            assertThat(variables).size().isEqualTo(1);
            I_VariableDefinition variableDefinition = variables.get(0);
            I_VariableDefinition expected = I_VariableDefinitionHelper.build("ehr_id/value", "id", "e", false, false, false);
            I_VariableDefinitionHelper.checkEqualWithoutFuncParameters(variableDefinition, expected);
        }
        ...
        {
            QueryCompilerPass2 cut = new QueryCompilerPass2();
            String aql = "select  e/ehr_id/value, a/context/health_care_facility/name/value, d/description[at0001]/items[at0002]/value " +
            ...
            I_VariableDefinition expected1 = I_VariableDefinitionHelper.build("ehr_id/value", null, "e", false, false, false);
            ...
            I_VariableDefinition expected2 = I_VariableDefinitionHelper.build("context/health_care_facility/name/value", null, "a", false, false, false);
            I_VariableDefinitionHelper.checkEqualWithoutFuncParameters(variableDefinition1, expected1);

            I_VariableDefinition variableDefinition3 = variables.get(1);
            I_VariableDefinition expected3 = I_VariableDefinitionHelper.build("description[at0001]/items[at0002]/value", null, "d", false, false, false);
            I_VariableDefinitionHelper.checkEqualWithoutFuncParameters(variableDefinition1, expected1);
        }
    }
    ...
    public void getTopAttributes() {
        ...
        {
            QueryCompilerPass2 cut = new QueryCompilerPass2();
            String aql = "select TOP 2 e/ehr_id/value " +
                    "from EHR e ";
            ParseTree tree = QueryHelper.setupParseTree(aql);
            walker.walk(cut, tree);
            TopAttributes actual = cut.getTopAttributes();
        ...
        {
            QueryCompilerPass2 cut = new QueryCompilerPass2();
            String aql = "select TOP 2 BACKWARD e/ehr_id/value " +
                    "from EHR e ";
            ParseTree tree = QueryHelper.setupParseTree(aql);
            walker.walk(cut, tree);
            TopAttributes actual = cut.getTopAttributes();
        ...
        {
            QueryCompilerPass2 cut = new QueryCompilerPass2();
            String aql = "select TOP 2 FORWARD e/ehr_id/value " +
                    "from EHR e ";
            ParseTree tree = QueryHelper.setupParseTree(aql);
            walker.walk(cut, tree);
            TopAttributes actual = cut.getTopAttributes();
