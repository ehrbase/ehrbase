...
public class I_VariableDefinitionHelper {
  ...
  public static void checkEqualWithoutFuncParameters(
      I_VariableDefinition actual, I_VariableDefinition expected) {
  ...
  public static I_VariableDefinition build(
    ...
    return new I_VariableDefinition() {
      ...
      public I_VariableDefinition clone() throws CloneNotSupportedException {
        super.clone();
        return I_VariableDefinitionHelper.build(
            path, alias, identifier, distinct, function, extension);
      }
