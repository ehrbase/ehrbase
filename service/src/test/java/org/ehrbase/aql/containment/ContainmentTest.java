...
public class ContainmentTest extends TestAqlBase {
  ...
  public void testInterpretContainement_testehr_ested_5_levels_contains() {
    ...
    String query =
        "SELECT c/uid/value, cluster2/items[at0002]/value"
  ...
  public void testContainNotCommutative() {
    ...
    // the first query check for composition contains admin_entry contains both cluster a AND
    // cluster n
    String query =
        "SELECT u"
            + " FROM EHR e "
