...
public class GenericJsonPathTest {
    ...
    public void jqueryPath() {
        ...
        assertEquals("'{context,other_context,/items[openEHR-EHR-CLUSTER.composition_context_detail.v1],$AQL_NODE_ITERATIVE$}'", new GenericJsonPath("context/other_context/items[openEHR-EHR-CLUSTER.composition_context_detail.v1]").jqueryPath());
        assertEquals("'{context,other_context,/items[openEHR-EHR-CLUSTER.composition_context_detail.v1],$AQL_NODE_ITERATIVE$,/items[at0001],$AQL_NODE_ITERATIVE$}'", new GenericJsonPath("context/other_context/items[openEHR-EHR-CLUSTER.composition_context_detail.v1]/items[at0001]").jqueryPath());
        assertEquals("'{context,other_context,/items[openEHR-EHR-CLUSTER.composition_context_detail.v1],$AQL_NODE_ITERATIVE$,/items[at0001],$AQL_NODE_ITERATIVE$,/value,value}'", new GenericJsonPath("context/other_context/items[openEHR-EHR-CLUSTER.composition_context_detail.v1]/items[at0001]/value/value").jqueryPath());
