...
public class TestUC20 extends UC20 {

    public TestUC20(){
        super();
        this.expectedSqlExpression =
                "select jsonb_extract_path_text(cast(\"ehr\".\"js_dv_coded_text_inner\"(\"ehr\".\"entry\".\"category\") as jsonb),'definingCode') as \"/category/defining_code\"" +
                        " from \"ehr\".\"entry\"" +
