...
public class IterativeNodeTest {
  ...
  */
   ...
   *
   * <p>(jsonb_array_elements(( (jsonb_array_elements (("ehr"."entry"."entry" #>>
   * '{/composition[openEHR-EHR-COMPOSITION.adverse_reaction_list.v1 and name/value=''Adverse
   * reaction
   * list''],/content[openEHR-EHR-SECTION.allergies_adverse_reactions_rcp.v1],0,/items[openEHR-EHR-EVALUATION.adverse_reaction_risk.v1]}'
   * )::jsonb) ) #>>'{/data[at0001],/items[at0009],0,/items[at0011]}' )::jsonb) )::jsonb #>>
   * '{/value, value}'
   *
   * @throws Exception
   */
