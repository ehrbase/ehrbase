...
public class TestUC21 extends UC21 {
    ...
    public TestUC21(){
        ...
        this.expectedSqlExpression =
                "select jsonb_extract_path_text(cast(\"ehr\".\"js_dv_coded_text_inner\"(\"ehr\".\"entry\".\"category\") as jsonb),'definingCode','terminologyId','value') as \"/category/defining_code/terminology_id/value\"" +
                        " from \"ehr\".\"entry\"" +
