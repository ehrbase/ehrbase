...
public class TestAqlBase {
  ...
  @ClassRule public static CacheRule cacheRule = new CacheRule();
  ...
  public static void beforeClass() throws Exception {
    ...
    try {
      testDomainAccess =
          new DummyDataAccess(context, knowledge, null, KnowledgeCacheHelper.buildServerConfig());
    } catch (Exception e) {
      e.printStackTrace();
    }
    ...
    knowledge.addOperationalTemplate(opt);
    opt =
        new FileInputStream("./src/test/resources/knowledge/operational_templates/nested.en.v1.opt")
            .readAllBytes();
    knowledge.addOperationalTemplate(opt);
    opt =
        new FileInputStream(
