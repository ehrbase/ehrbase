...
public interface CacheProvider {
    EhrBaseCache<String, WebTemplate> TEMPLATE_CACHE = new EhrBaseCache<>("templateCache");
    ...
    EhrBaseCache<Pair<String, String>, DocumentContext> EXTERNAL_FHIR_TERMINOLOGY_CACHE =
