...
public class Templates {
  ...
  /**
   * build the results for a jsonpath query applied to all defined templates in the
  ...
  /**
   * build the results for a jsonpath query applied to a defined templates in the
   * KnowledgeCacheService
   *
   * @param templateId
   * @param jsonQueryExpression
   * @return
   */
  public JsonPathQueryResult resolveForTemplate(
      String templateId, List<NodeId> jsonQueryExpression) {
