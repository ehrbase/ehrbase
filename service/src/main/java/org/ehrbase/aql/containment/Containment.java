 ...
 *
 * <p>This class is used to resolve a symbol in an AQL expression by associating its corresponding
 * archetype Id, class type (EHR, COMPOSITION etc.). Once resolved it holds the path for a given
 * template. Created by christian on 4/4/2016.
 */
public class Containment implements Serializable {
  ...
  public boolean equals(Object o) {
    ...
    if (getSymbol() != null ? !getSymbol().equals(that.getSymbol()) : that.getSymbol() != null)
      return false;
    if (archetypeId != null ? !archetypeId.equals(that.archetypeId) : that.archetypeId != null)
      return false;
