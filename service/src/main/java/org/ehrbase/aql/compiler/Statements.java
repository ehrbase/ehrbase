...
public class Statements {
  ...
  public Statements(
      ...
      I_OpenehrTerminologyServer tsAdapter) {
  ...
  private void appendEhrPredicate(FromEhrDefinition.EhrPredicate ehrPredicate) {
    ...
    whereClause.add(
        new VariableDefinition(ehrPredicate.getField(), null, ehrPredicate.getIdentifier(), false));
  ...
  public VariableDefinitions getVariables() {
    boolean containsNonEhrVariable =
        variables.stream()
            ...
            .anyMatch(
                c ->
                    c != null
                        && !c.getClass().isAssignableFrom(FromEhrDefinition.EhrPredicate.class));
    boolean containsOnlyEhrAttributes =
        variables.stream()
            .filter(
                v ->
                    identifierMapper.getContainer(v.getIdentifier()) != null
                        && identifierMapper
