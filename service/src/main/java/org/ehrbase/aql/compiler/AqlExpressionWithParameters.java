...
public class AqlExpressionWithParameters extends AqlExpression {
   ...
   *
   * <p>"query-parameters": { "ehr_id": "7d44b88c-4199-4bad-97dc-d78268e01398", "systolic_bp": 140 }
   *
   * @param query
  ...
  /**
   * Substitute parameters in aql expression A parameter symbol starts with a '$' and a combination
   * of alphanumeric with '-' or '_' If the parameter value is a string or a UUID it is single
   * quoted.
   *
   * @param query
