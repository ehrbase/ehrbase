...
public class SuperQuery {
  ...
  public SuperQuery(
      I_DomainAccess domainAccess, VariableDefinitions variableDefinitions, SelectQuery query) {
  ...
  private List<Field> selectDistinctFields() {
    ...
    while (iterator.hasNext()) {
      ...
      if (variableDefinition instanceof FunctionDefinition) {
        ...
        for (FuncParameter funcParameter :
            ((FunctionDefinition) variableDefinition).getParameters()) {
        ...
        else fields.add(DSL.fieldByName(variableDefinition.getAlias()));
      }
    }
  ...
  private SelectQuery selectAggregate(SelectQuery selectQuery) {
    ...
    while (iterator.hasNext()) {
      I_VariableDefinition variableDefinition = iterator.next();
      String alias =
          variableDefinition.getAlias() == null || variableDefinition.getAlias().isEmpty()
      ...
      if (variableDefinition.isFunction()) {
        ...
        FunctionExpression functionExpression =
            new FunctionExpression(variableDefinitions, variableDefinition);
        ...
        if (variableDefinition.isDistinct()) fields.add(DSL.fieldByName("DISTINCT " + alias));
        else fields.add(DSL.fieldByName(alias));
      }
    }
