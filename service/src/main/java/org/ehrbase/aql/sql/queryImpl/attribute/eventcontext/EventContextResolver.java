  ...
  public Field<?> sqlField(String path) {
    ...
    if (path.startsWith("context/setting")) {
      return new SettingResolver(fieldResolutionContext, joinSetup)
          .sqlField(new AttributePath("context/setting").redux(path));
    }
