    ...
    private TaggedStringBuilder buildWhereCondition(ExistsMode existsMode, int whereCursor, MultiFieldsMap multiFieldsMap,  int selectCursor, MultiFieldsMap multiSelectFieldsMap, TaggedStringBuilder taggedBuffer, List<Object> item) throws UnknownVariableException {
        for (Object part : item) {
            if (part instanceof String)
                ...
                TaggedStringBuilder taggedStringBuilder = whereVariable.encodeWhereVariable(existsMode, isFollowedBySQLConditionalOperator, whereCursor, multiFieldsMap, selectCursor, multiSelectFieldsMap, (VariableDefinition) part, null);
                ...
                TaggedStringBuilder taggedStringBuilder = buildWhereCondition(existsMode, whereCursor, multiFieldsMap, selectCursor, multiSelectFieldsMap, taggedBuffer, (List) part);
                taggedBuffer.append(taggedStringBuilder.toString());
                taggedBuffer.setTagField(taggedStringBuilder.getTagField());
            }
        }
            ...
            if (item instanceof String) {
                switch (((String) item).trim().toUpperCase()) {
                    ...
                    case EXISTS:
                        ...
                        notExists = false;
                        if (inExists.equals(ExistsMode.UNSET))
                ...
                if (isFollowedBySQLConditionalOperator(cursor)) {
                    TaggedStringBuilder encodedVar = whereVariable.encodeWhereVariable(inExists, isFollowedBySQLConditionalOperator, whereCursor, multiWhereFieldsMap, selectCursor, multiSelectFieldsMap, (I_VariableDefinition) item, null);
                    isFollowedBySQLConditionalOperator = whereVariable.isFollowedBySQLConditionalOperator();
                    ...
                    if (new VariablePath(((I_VariableDefinition) item).getPath()).hasPredicate()) {
                        TaggedStringBuilder variableSQL = whereVariable.encodeWhereVariable(inExists, isFollowedBySQLConditionalOperator, whereCursor, multiWhereFieldsMap, selectCursor, multiSelectFieldsMap, (I_VariableDefinition) item, null);
                        isFollowedBySQLConditionalOperator = whereVariable.isFollowedBySQLConditionalOperator();
                        inExists = whereVariable.inExists();

                        String expanded = expandForLateral(templateId, variableSQL, (I_VariableDefinition)item, multiSelectFieldsMap );
                        if (StringUtils.isNotBlank(expanded)) {
                        ...
                        String expanded = expandForLateral(templateId, whereVariable.encodeWhereVariable(inExists, isFollowedBySQLConditionalOperator, whereCursor, multiWhereFieldsMap, selectCursor, multiSelectFieldsMap, (I_VariableDefinition) item, null), (I_VariableDefinition)item, multiSelectFieldsMap );
                        isFollowedBySQLConditionalOperator = whereVariable.isFollowedBySQLConditionalOperator();
                        inExists = whereVariable.inExists();
                ...
                TaggedStringBuilder taggedStringBuilder = buildWhereCondition(inExists, whereCursor, multiWhereFieldsMap, selectCursor, multiSelectFieldsMap, taggedBuffer, (List) item);
                taggedBuffer.append(taggedStringBuilder.toString());
                taggedBuffer.setTagField(taggedStringBuilder.getTagField());
            }
