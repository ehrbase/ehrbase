...
public class AqlRoutines extends AqlDialects {
  ...
  public static Field<JSONB> jsonArraySplitElements(
      Configuration configuration, Field<JSONB> jsonbVal) {
  ...
  public static Field<JSONB> jsonpathItem(
  ...
  public static String jsonpathItemAsText(
      Configuration configuration, Field<JSONB> jsonbVal, String[] elements) {
    isSupported(configuration);
    return "jsonb_extract_path_text(" + jsonbVal + "," + String.join(",", elements) + ")";
  }
