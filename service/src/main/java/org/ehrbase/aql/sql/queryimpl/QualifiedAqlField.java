...
public class QualifiedAqlField {
    ...
    private String rightMostJsonbExpression; //whenever we use lateral we have to separate the lateral sql from the select part
    ...
    public QualifiedAqlField duplicate() {
        return new QualifiedAqlField(this.getSQLField(), this.itemType, this.itemCategory, this.rightMostJsonbExpression);
    }
