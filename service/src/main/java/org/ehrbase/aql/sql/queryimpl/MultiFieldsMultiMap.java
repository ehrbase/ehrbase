...
public class MultiFieldsMultiMap extends MultiFieldsMap{
    ...
    private String variableIdentifierPath(MultiFields multiFields){
        ...
        else if (multiFields.getVariableDefinition().getPredicateDefinition() != null && multiFields.getVariableDefinition().getPredicateDefinition().getOperand2() != null){
            stringBuilder.append("::");
            stringBuilder.append(multiFields.getVariableDefinition().getPredicateDefinition().getOperand2());
        }
