...
public class JoinBinder implements I_JoinBinder {
  ...
  public JoinBinder(
      I_DomainAccess domainAccess, SelectQuery<?> selectQuery, boolean isWholeComposition) {
  ...
  private void joinContextFacility(
      SelectQuery<?> selectQuery, CompositionAttributeQuery compositionAttributeQuery) {
