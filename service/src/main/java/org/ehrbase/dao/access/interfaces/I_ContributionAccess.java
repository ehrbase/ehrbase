...
public interface I_ContributionAccess extends I_SimpleCRUD {
  ...
  /**
   * retrieve a contribution from its object ID and a timestamp FIXME: note: this only looks for
   * instances in *_history table, see called method for details on problem - also naming
   * suggestively wrong?
   *
   * @param domainAccess SQL context
   ...
   */
  static I_ContributionAccess retrieveVersionedInstance(
      I_DomainAccess domainAccess, UUID contributionObjId, Timestamp timestamp) {
  ...
  /**
   * Commits given input as contribution record. Creation of audit is required beforehand. All
   * parameters are optional and will be provided with default values if NULL.
   *
  ...
  /**
   * Commits given input as contribution record. Embeds creation of audit for this commit. All
   * parameters are optional and will be provided with default values if NULL.
   *
   * @param transactionTime Timestamp of transaction time
   ...
   * @param contributionType String representation of contribution type
   * @param contributionState String representation of contribution state
   * @param contributionChangeType String representation of contribution change type (part of
   *     AuditDetails)
   ...
   * @param contributionChangeType ContributionChangeType representation of contribution change type
   *     (part of AuditDetails)
   * @param description Description (part of AuditDetails)
   * @return True for success
   */
  Boolean update(
   ...
   * the signature is stored in the Contribution Version entry, the state of the contribution is
   * then 'complete'
   *
