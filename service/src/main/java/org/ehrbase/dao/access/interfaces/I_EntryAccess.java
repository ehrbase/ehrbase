...
public interface I_EntryAccess extends I_SimpleCRUD {
  ...
  // TODO Doc: appears to be explicitly used with versions other than the latest (because accessing
  // only "entry_history" table)
  static List<I_EntryAccess> retrieveInstanceInCompositionVersion(
    ...
    return EntryAccess.retrieveInstanceInCompositionVersion(
