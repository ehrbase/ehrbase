...
public class StoredQueryAccess extends DataAccess implements I_StoredQueryAccess {
  ...
  public StoredQueryAccess(
      I_DomainAccess domainAccess, String qualifiedQueryName, String sourceAqlText) {
    super(domainAccess);

    storedQueryRecord = domainAccess.getContext().newRecord(STORED_QUERY);

    StoredQueryQualifiedName storedQueryQualifiedName =
        new StoredQueryQualifiedName(qualifiedQueryName);
    ...
    if (storedQueryQualifiedName.isSetSemVer())
      storedQueryRecord.setSemver(storedQueryQualifiedName.semVer());
  ...
  public static StoredQueryAccess retrieveQualified(
      I_DomainAccess domainAccess, String qualifiedName) {
