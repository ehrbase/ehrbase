...
public class TemplateStoreAccess extends DataAccess implements I_TemplateStoreAccess {
  ...
  public static I_TemplateStoreAccess retrieveInstanceByTemplateId(I_DomainAccess domainAccess,
      String templateId) {
  ...
  public static List<TemplateMetaData> fetchAll(I_DomainAccess domainAccess) {
    Result<Record2<String, Timestamp>> records = domainAccess.getContext()
        .select(TEMPLATE_STORE.CONTENT, TEMPLATE_STORE.SYS_TRANSACTION).from(TEMPLATE_STORE)
        .fetch();
  ...
  public static Set<String> fetchAllTemplateIds(I_DomainAccess domainAccess) {
    Result<Record1<String>> records = domainAccess.getContext()
        .select(TEMPLATE_STORE.TEMPLATE_ID).from(TEMPLATE_STORE).fetch();
    return records.parallelStream()
   ...
   */
  public static String adminUpdateTemplate(I_DomainAccess domainAccess,
