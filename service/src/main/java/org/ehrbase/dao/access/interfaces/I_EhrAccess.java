...
public interface I_EhrAccess extends I_SimpleCRUD {
    ...
    static I_EhrAccess getInstance(
            I_DomainAccess domain, UUID partyId, UUID systemId, UUID directoryId, UUID accessId, UUID ehrId, String tenantIdentifier) {
        return new EhrAccess(
                domain.getContext(), domain.getServerConfig(), partyId, systemId, directoryId, accessId, ehrId, tenantIdentifier);
    }
