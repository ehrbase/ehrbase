...
/**
 * Stripped down DAO interface to perform some `*_history` table related actions. Composition access
 * handling in general is done through the {@link CompositionAccess} class.
 */
public interface I_CompositionHistoryAccess extends I_SimpleCRUD {
   ...
   */
  static I_CompositionHistoryAccess retrieveLatest(
