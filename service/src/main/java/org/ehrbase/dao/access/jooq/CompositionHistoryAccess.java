...
/**
 * Stripped down DAO to perform some `*_history` table related actions. Composition access handling
 * in general is done through the {@link CompositionAccess} class.
 */
public class CompositionHistoryAccess extends DataAccess implements I_CompositionHistoryAccess {
  ...
  public Boolean update() {
    ...
    // manually constructing an update query, because _history tables aren't of type
    // UpdatableRecord, because table has no PK
  ...
  public static I_CompositionHistoryAccess retrieveLatest(
