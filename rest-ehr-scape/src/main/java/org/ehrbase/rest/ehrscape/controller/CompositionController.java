...
@Tag(name = "EhrScape API - Composition")
@RestController
...
public class CompositionController extends BaseController {
    ...
    @GetMapping(path = "/{id}")
    public ResponseEntity<CompositionResponseData> getComposition(@PathVariable("id") String compositionId,
    ...
    @PutMapping(path = "/{id}")
    public ResponseEntity<ActionRestResponseData> update(@PathVariable("id") UUID compositionId,
                                                         @RequestParam(value = "format", defaultValue = "XML") CompositionFormat format,
                                                         @RequestParam(value = "templateId", required = false) String templateId,
                                                         @RequestBody String content) {
