 ...
 * Workaround for non-functional @Example annotation. See:
 * https://github.com/springfox/springfox/issues/2822 // TODO check licence of blog post source
...
public class OperationNotesResourcesReader implements OperationBuilderPlugin {
  ...
  static final Logger logger = LoggerFactory.getLogger(OperationNotesResourcesReader.class);
